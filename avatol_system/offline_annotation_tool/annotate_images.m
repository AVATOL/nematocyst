...
ready = questdlg(['We will start annotating images. For each image a window will pop up accepting annotations. '...
    ...
    'When you are done, press the [ENTER] key or right click anywhere on the image to exit. '...
    '(Note that the program will automatically connect the last point to the first point!) '...
    'From there, accept or reject the annotation, give it a character ID and state, then continue. '...
    'Are you ready?']);
