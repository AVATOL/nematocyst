...
namespace HCSearch
{
	...
	public:
		...
		// Search procedure implemented by extending class
		...
		// Convenience function for LC-search
		...
		// Convenience function for HC-search
		...
		// Convenience function for learning H search
		...
		// Convenience function for learning C search
		...
		// Convenience function for learning C with oracle H search
	...
	protected:
		// Stub for selecting a subset of the open set for processing.
		virtual vector< ISearchNode* > selectSubsetOpenSet(SearchNodePQ& openSet)=0;

		// Stub for expanding the elements.
		// openSet may be modified.
		// costSet is used for duplicate checking.
		virtual SearchNodePQ expandElements(vector< ISearchNode* > subsetOpenSet, SearchNodePQ& openSet, SearchNodePQ& costSet)=0;

		// Stub for choosing successors among the expanded.
		...
		// checks if the state is duplicate among the states in the priority queue.
