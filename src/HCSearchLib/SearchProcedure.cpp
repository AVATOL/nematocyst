...
namespace HCSearch
{
	...
	IRankModel* Learner::initializeLearning(RankerType rankerType, SearchType searchType)
	{
	...
	void Learner::finishLearning(IRankModel* learningModel, SearchType searchType)
	{
