...
namespace HCSearch
{
	...
	public:
		...
		string OUTPUT_PAIRWISE_MODEL_FILE;
		string OUTPUT_PAIRWISE_FEATURES_FILE;
		string OUTPUT_PAIRWISE_PREDICT_FILE;

		string OUTPUT_RANKLIB_FEATURES_FILE;
		string OUTPUT_RANKLIB_SCORE_FILE;
